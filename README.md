# Paulo Cesar Pereira Da Costa
 ...
 <b>
Sou desenvolvedor Java Spring, possuo graduação em tecnologia em analise e desenvolvimento de sistemas, realizei o curso de especialista Spring Rest pela Algaworks onde apliquei vários frameworks e suas tecnologias com o Java Spring, JPA, Flayway, Maven, Jenkins, Git, Heroku, Postman, DBeaber, MySQL, Postgres, Docker, Eclipse, Spring Tools Suite , VS Code, IntelliJ, OAuth2, Redis, OpenAPI/Swagger, Squiggly, Jasper Reports, Model Mapper, AWS, S3, Spring Doc. Durante o período da graduação desenvolvi habilidades em desenvolvimento de aplicação em Java, banco de dados e metodologias ágeis (Lean, Scrum, Kamban), Design Thinking e CI/CD. Para aperfeiçoar meu conhecimento, também desenvolvi atividades de extensão relacionadas a programação em C#, HTML5, CSS e Javascript, Java e Orientação a Objetos para me manter atualizado com as novas versões dos pacotes Java e aprimorar a qualidade dos meus códigos. Trabalhei como Desenvolvedor na empresa Ahr Brasil, na qual atuei no desenvolvimento de projetos realizados em Spring Boot e Angular responsável pela integração com o E-Social. Embora minha especialização esteja principalmente no desenvolvimento backend, tenho familiaridade com o framework Angular, permitindo assim colaborar efetivamente com equipes frontend, garantindo uma comunicação eficiente e uma experiência de usuário coesa.
 </b>
<br>
