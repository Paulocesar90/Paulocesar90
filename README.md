# Paulo Cesar Pereira Da Costa
 ...
 <b>
Sou desenvolvedor Java Spring. Possuo graduação em tecnologia em análise e desenvolvimento de sistemas. Realizei o curso de  Especialista Spring Rest pela Algaworks onde apliquei vários frameworks e suas tecnologias com o Java Spring, JPA, Flayway, Maven, Jenkins, Git, Heroku, Postman, DBeaber, MySQL, Postgres, Docker, Eclipse Spring Tools Suit, VSCode, Intellij,OAuth2,Redis,OpenAPI/Swagger,Squiggly,JasperReports,ModelMapper,AWS,S3,
SpringDoc. Durante o período da graduação desenvolvi habilidades em desenvolvimento de aplicações Java, banco de dados e metodologias ágeis (Lean, Scrum, Kamban), Design Thinking e CI/CD. Para aperfeiçoar meu conhecimento, durante a graduação, também desenvolvi atividades de extensão relacionadas à programação em C#, HTML5, CSS e Javascript,Java e Orientação a Objetos para me manter atualizado com as novas versões dos pacotes Java e aprimorar a qualidade dos meus códigos.Atualmente trabalho de Desenvolvedor Jr na empresa AhrBrasil,onde tive contato com JavaEE,SGBD FireBird ,implementações de infra com Spring Boot 2. Hoje  me mantenho atualizado com as tecnologias relacionadas ao front-end e back-end e sigo aprendendo e amando mais a cada dia.
 </b>
<br>
